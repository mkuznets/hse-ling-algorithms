...
| Mon 15/10 	| 2S    	| Data structures cont’d: dynamic array, amortised complexity, multidimentional array in memory (matrices, row- and column-major orders)                                                                                                                                        	|
| Fri 19/10 	| L     	| Data structures cont’d: space-efficient dynamic array, implementations of queue (circular buffer, two dynamic arrays), accounting method for proving amortised complexity, hashtables.                                                                                        	|
| Mon 29/10 	| 2S    	|                                                                                                                                                                                                                                                                               	|
